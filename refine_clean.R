# Using "readxl" package to read in the Excel file
# Using "dplyr" and "tidyr" packages to manipulate the data

library(readxl)
library(tidyr)
library(dplyr)

# Load the original CSV file from Excel
...
# Search for company names that are not correctly spelled, make the correction, and update the tibble
